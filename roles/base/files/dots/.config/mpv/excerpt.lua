...
mp.add_key_binding("b", "excerpt_mark_begin", excerpt_mark_begin_handler)
mp.add_key_binding("shift+b", "excerpt_seek_begin", excerpt_seek_begin_handler)
mp.add_key_binding("n", "excerpt_mark_end", excerpt_mark_end_handler)
mp.add_key_binding("shift+n", "excerpt_seek_end", excerpt_seek_end_handler)
